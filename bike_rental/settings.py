...
SECRET_KEY = 'django-insecure-dk*9=mnuh1+8%*4v2@ii7f6o90x$*dej&t*u9i+@ooy7h@8^4o'
...
# Ensure the default Django `User` model is used
...
# Khalti API keys
KHALTI_SECRET_KEY = "35fe7785748249e4824174b29424f582"
KHALTI_PUBLIC_KEY = "35fe7785748249e4824174b29424f582"
